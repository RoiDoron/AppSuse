...
export function MailDetails({mailToShow,setShowMail,onRemoveMail}) {
    const mail=mailToShow

    return <section className="mail-details">
        <button className="mail-details-btn fa-solid fa-arrow-left" onClick={()=>setShowMail(false)}></button>
        <button className="mail-delete-btn fa-regular fa-trash-can" onClick={()=>onRemoveMail(mailToShow)}></button>
